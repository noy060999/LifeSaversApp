...
class ReportsGenViewControllerCity: UIViewController, ChartViewDelegate, MFMailComposeViewControllerDelegate {
    ...
    @IBAction func sendMailAction(_ sender: Any) {
        if MFMailComposeViewController.canSendMail() {
            ...
            FirebaseService.getEmailBody(category: "city") { msg in
                if (msg != ""){
                    print(msg)
                    body = msg
                ...
                mail.setSubject("תרומות דם לפי עיר")
